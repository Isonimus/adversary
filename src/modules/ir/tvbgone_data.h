/**
 * @file tvbgone_data.h
 * @brief TV-B-Gone IR code database
 * 
 * Auto-generated from Ken Shirriff's Arduino-TV-B-Gone.
 * Credit: Ken Shirriff, Mitch Altman, Limor Fried.
 */
...
static const IrCode* const NA_DATABASE[] PROGMEM = {
  &code_na000Code,
  &code_na001Code,
  &code_na002Code,
  &code_na003Code,
...
static const size_t NA_DATABASE_SIZE = 137;

static const IrCode* const EU_DATABASE[] PROGMEM = {
  &code_eu000Code,
  &code_eu001Code,
  &code_eu002Code,
...
static const size_t EU_DATABASE_SIZE = 145;
